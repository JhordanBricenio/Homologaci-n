...
function Evaluacion() {
  return (
    <div className="flex flex-row">
      ...
      <div className="w-full relative bg-whitesmoke overflow-hidden flex flex-col items-start justify-start pt-[35px] px-[20px] pb-[281px] box-border tracking-[normal] leading-[normal] mq450:pl-5 mq450:pr-5 mq450:box-border mq725:pl-[59px] mq725:pr-[59px] mq725:box-border">
        <div className="w-10 h-[30px] absolute !m-[0] top-[-5px] left-[15px] z-[2]">
        ...
        <section className="self-stretch flex flex-row items-start justify-start relative max-w-full text-left text-sm text-white-color font-typography-body2">
          ...
          <div className="!m-[0] absolute top-[-24px] right-[11px] rounded-8xs  bg-darkslateblue flex flex-row items-start justify-start pt-[15px] px-[26px] pb-4 z-[1]">
