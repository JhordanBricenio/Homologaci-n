...
const Page: FunctionComponent = () => {
  return (
    <div className="w-[1484px] bg-whitesmoke max-w-full overflow-y-auto flex flex-row items-start justify-start py-[60px] px-[30px] box-border tracking-[normal] leading-[normal]">
      <section className="h-[939px] flex-1 rounded bg-white flex flex-col items-start justify-start pt-[314px] px-7 pb-[30px] box-border gap-[50px] max-w-full text-left text-base text-white font-inter lg:h-auto mq750:gap-[25px] mq750:pt-[133px] mq750:box-border mq1050:pt-[204px] mq1050:pb-5 mq1050:box-border">
