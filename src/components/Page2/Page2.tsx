...
const Page2: FunctionComponent = () => {
  return (
    <div className="flex flex-row mt-20">
      ...
      <div className="w-[1492px] bg-whitesmoke max-w-full overflow-y-auto flex flex-row items-start justify-start py-[60px] px-[10px] box-border tracking-[normal] leading-[normal]">
