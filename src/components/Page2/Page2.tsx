...
const Page2: FunctionComponent = () => {
  return (
    <div className="w-[1492px] bg-whitesmoke max-w-full overflow-y-auto flex flex-row items-start justify-start py-[60px] px-[30px] box-border tracking-[normal] leading-[normal]">
      <section className="h-[876px] flex-1 rounded bg-white flex flex-col items-start justify-start pt-[314px] px-7 pb-[30px] box-border gap-[50px] max-w-full text-left text-base text-white font-inter mq750:gap-[25px] mq750:pt-[133px] mq750:box-border mq1050:pt-[204px] mq1050:pb-5 mq1050:box-border mq1225:h-auto">
          ...
          <div className="self-stretch flex flex-row items-start justify-start py-0 pr-0 pl-0.5 box-border max-w-full text-13xl text-darkslateblue">
            <div className="flex-1 flex flex-col items-start justify-start gap-[15px] max-w-full">
              ...
              <div className="self-stretch flex flex-row flex-wrap items-start justify-start gap-[30px] max-w-full text-black">
                ...
                <div className="flex-1 overflow-hidden flex flex-col items-start justify-start gap-[10px] min-w-[775px] max-w-full mq1050:min-w-full">
                  <div className="self-stretch flex flex-row items-center justify-start gap-[30px] max-w-full mq1050:flex-wrap">
                    ...
                    <div className="flex-1 flex flex-row items-center justify-between min-w-[372px] max-w-full gap-[20px] text-center text-sm text-white mq750:flex-wrap mq750:min-w-full">
                      <Button
                        className="h-[45px] w-[97px] min-h-[30px] max-h-[60px]"
                      ...
                      <div className="h-[45px] rounded bg-cornflowerblue hidden flex-row items-center justify-center py-2 px-6 box-border min-h-[30px] max-h-[60px] whitespace-nowrap">
                        <div className="h-[17px] relative uppercase inline-block whitespace-nowrap">
                          guardar los cambios
                        </div>
                      </div>
                      <div className="h-[45px] rounded bg-cornflowerblue hidden flex-row items-center justify-center py-2 px-2.5 box-border min-h-[30px] max-h-[60px]">
                        <div className="relative uppercase">cancelar</div>
                      </div>
                      <Button
                        className="h-[45px] w-[275px] min-h-[30px] max-h-[60px]"
                        disableElevation={true}
                        variant="contained"
                        sx={{
                          color: "#fff",
        ...
        <div className="self-stretch flex flex-row items-start justify-start py-0 px-0.5 box-border shrink-0 max-w-full text-black">
          <div className="flex-1 flex flex-row flex-wrap items-start justify-start gap-[30px] max-w-full">
            <div className="flex-1 shadow-[0px_0px_2px_rgba(0,_0,_0,_0.25)] rounded bg-white box-border flex flex-col items-start justify-start pt-[50px] pb-[30px] pr-[30px] pl-[29px] relative min-w-[328px] min-h-[213px] max-w-full border-[1px] border-solid border-black">
            ...
            <div className="flex-1 shadow-[0px_0px_2px_rgba(0,_0,_0,_0.25)] rounded bg-white box-border flex flex-col items-start justify-start pt-[50px] px-[30px] pb-[30px] relative gap-[10px] min-w-[328px] min-h-[215px] max-w-full border-[1px] border-solid border-black mq1050:pl-[30px] mq1050:pt-[50px] mq1050:pr-[30px] mq1050:box-border mq1225:pl-[30px] mq1225:pt-[50px] mq1225:pr-[30px] mq1225:box-border">
              <div className="self-stretch rounded bg-white overflow-hidden flex flex-col items-start justify-start gap-[20px]">
                <div className="self-stretch overflow-hidden hidden flex-row items-center justify-start gap-[10px] mq750:flex-wrap">
                  ...
                  <img
                    ...
                    alt=""
                    src="/plus-button@2x.png"
                  />
                </div>
                <div className="self-stretch overflow-hidden flex flex-col items-start justify-start gap-[10px] text-cornflowerblue">
                  <div className="self-stretch flex flex-row items-center justify-start py-0 pr-[248.3px] pl-0 gap-[10px] mq750:flex-wrap mq450:pr-5 mq450:box-border">
                  ...
                  <div className="self-stretch flex flex-row items-center justify-start py-0 pr-[147px] pl-0 gap-[10px] mq750:flex-wrap mq450:pr-5 mq450:box-border">
                  ...
                  <div className="self-stretch flex flex-row items-center justify-start py-0 pr-[54px] pl-0 gap-[10px] mq750:flex-wrap mq450:pr-5 mq450:box-border">
                  ...
                  <div className="self-stretch flex flex-row items-center justify-start py-0 pr-[249.3px] pl-0 gap-[10px] mq750:flex-wrap mq450:pr-5 mq450:box-border">
                    <div className="relative [text-decoration:underline] font-medium inline-block min-w-[89px]">
                      Categoría 7
                    </div>
                    <div className="flex flex-row items-start justify-start">
            ...
            <div className="flex-1 shadow-[0px_0px_2px_rgba(0,_0,_0,_0.25)] rounded bg-white box-border flex flex-col items-start justify-start pt-[50px] px-[30px] pb-[30px] relative gap-[10px] min-w-[328px] min-h-[215px] max-w-full border-[1px] border-solid border-black">
              <div className="self-stretch rounded bg-white overflow-hidden flex flex-col items-start justify-start gap-[20px]">
                <div className="self-stretch overflow-hidden hidden flex-row items-center justify-start gap-[10px] mq750:flex-wrap">
                  <div className="h-[43px] w-[270px] rounded bg-white box-border flex flex-row items-center justify-start py-3 px-4 gap-[10px] min-h-[30px] max-h-[60px] border-[2px] border-solid border-black">
                    <div className="self-stretch flex-1 relative flex items-center">
                  ...
                  <img
                    className="h-[30px] w-[30px] relative object-contain"
                    alt=""
                    src="/plus-button-1@2x.png"
                  />
                </div>
                <div className="self-stretch overflow-hidden flex flex-row flex-wrap items-start justify-between min-h-[135px] gap-[1.7666666666666704px]">
                  <button className="cursor-pointer py-1.5 px-[9px] bg-white w-[92px] box-border flex flex-row items-center justify-start gap-[10px] border-[1px] border-solid border-darkgray">
                    <div className="relative text-base font-medium font-inter text-cornflowerblue text-left inline-block min-w-[72px]">
                      Tag1Tag1
                    </div>
                    <div className="hidden flex-col items-center justify-center">
                      <div className="relative text-base font-inter text-cornflowerblue text-center">
                        X
                      </div>
                    </div>
                  </button>
        ...
        <div className="flex flex-row items-start justify-start py-0 px-0.5 box-border max-w-full shrink-0">
          <div className="flex flex-row items-start justify-start max-w-full">
            <div className="h-[267px] shadow-[0px_0px_2px_rgba(0,_0,_0,_0.25)] rounded bg-white box-border overflow-y-auto flex flex-col items-start justify-start pt-[43px] px-[29px] pb-[223px] gap-[40.5px] max-w-full border-[1px] border-solid border-black mq750:gap-[20px] mq1050:pt-7 mq1050:pb-[145px] mq1050:box-border mq450:pt-5 mq450:pb-[94px] mq450:box-border">
              <div className="mt-[-59.5px] flex flex-row items-start justify-start py-0 px-6">
                <div className="rounded bg-darkslateblue flex flex-row items-start justify-start py-2 pr-6 pl-[27px] box-border min-h-[30px] max-h-[60px] shrink-0 [debug_commit:1de1738]">
              ...
              <div className="w-[1022px] rounded bg-white overflow-x-auto shrink-0 flex flex-col items-start justify-start gap-[10px] [debug_commit:1de1738] max-w-full text-black">
                <div className="w-[1022px] overflow-hidden flex flex-row items-start justify-start gap-[30px]">
                  <div className="w-[400px] flex flex-row items-start justify-start gap-[10px] max-w-full">
                    ...
                    <img
                      ...
                      loading="lazy"
                      alt=""
                      src="/info-icon@2x.png"
                    />
                  </div>
                  <div className="flex-1 overflow-hidden flex flex-row items-center justify-start gap-[10px] max-w-full">
                ...
                <div className="w-[1022px] overflow-hidden flex flex-row items-start justify-start gap-[30px]">
                  <div className="w-[400px] flex flex-row items-start justify-start gap-[10px] max-w-full">
                    <div className="flex-1 relative inline-block min-w-[238px] max-w-full">
                      Estado de Omisiones tributarias Remitidas a Centrales de
                      Riesgo
                    </div>
                  ...
                  <div className="flex-1 flex flex-col items-start justify-start pt-[7px] px-0 pb-0 box-border max-w-full">
                    <div className="self-stretch overflow-hidden flex flex-row items-center justify-start gap-[10px] max-w-full">
                      <div className="flex flex-row items-center justify-start gap-[10px]">
                        <div className="flex flex-row items-center justify-start">
                          <div className="relative">
                            archivo actualmente subido
                  ...
                  <div className="w-[400px] flex flex-row items-start justify-start gap-[10px] max-w-full">
                    ...
                    <div className="flex flex-col items-start justify-start pt-[16.5px] px-0 pb-0">
                      <img
                        className="w-6 h-6 relative object-cover"
                        alt=""
                        src="/info-icon-4@2x.png"
                      />
                    </div>
                  </div>
                  <div className="flex-1 flex flex-col items-start justify-start pt-[16.5px] px-0 pb-0 box-border max-w-full">
                    <div className="self-stretch overflow-hidden flex flex-row items-center justify-start gap-[10px] max-w-full">
                      <div className="flex flex-row items-center justify-start gap-[10px]">
                        <div className="flex flex-row items-center justify-start">
                          <div className="relative">
                ...
                <div className="w-[1022px] overflow-hidden flex flex-row items-start justify-start gap-[30px]">
                  <div className="w-[400px] flex flex-row items-start justify-start gap-[10px] max-w-full">
                    <div className="h-[57px] flex-1 relative flex items-center min-w-[238px] max-w-full">
                  ...
                  <div className="flex-1 flex flex-col items-start justify-start pt-[16.5px] px-0 pb-0 box-border max-w-full">
                    <div className="self-stretch overflow-hidden flex flex-row items-center justify-start gap-[10px] max-w-full">
                      <div className="w-[243px] flex flex-row items-center justify-start gap-[10px]">
                        <div className="h-[19px] flex-1 flex flex-row items-center justify-start">
                          <div className="self-stretch flex-1 relative flex items-center">
                            archivo actualmente subido
                          </div>
                        </div>
