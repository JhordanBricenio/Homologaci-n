...
const Homologacion = () => {
  return (
    <div className="flex flex-row mt-60">
      ...
      <div className="w-full relative bg-whitesmoke overflow-hidden flex flex-col items-start justify-start pt-10 px-[18px] pb-[102px] box-border tracking-[normal] leading-[normal] mq450:pl-5 mq450:pr-5 mq450:box-border mq750:pl-[59px] mq750:pr-[59px] mq750:box-border">
